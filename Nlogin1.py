...
#===========
                    ...
                    line.sendMessage(to,"(｡◕‿◕｡)\nบอทยังทำงานคับท่าน😁")       
#==============================================================================#
                elif "ประทาน" == msg.text.lower():
                    msg.contentType = 13
                    line.sendMessage(to, "=========================")
                    line.sendContact(to, "u6f4b61984664e6725dcec16bcf639785")
                    line.sendContact(to, "u6f072a889514ba22c54b5a47474d8bc8")
                    line.sendContact(to, "u66149df5e8c4fd5f1d10dc6c4f7275c5")
...
#==============================================================================#
                    ...
                    msg.contentType = 13
                    line.sendMessage(to, "รองสวย & รองหล่อ \nŚẾL₣ВΌŦ (｡◕‿◕｡)")
                    line.sendContact(to, "u88664227869ee551c359b361250ed451")
                    line.sendContact(to, "u6ed0191f2dbf18a55da29b5ea0db833d")
                    line.sendContact(to, "u4b6312d300af9ec3ce4313add24c815d")
                    line.sendContact(to, "uef5d60cd272dec64c0f60b0f06707992")
                    line.sendContact(to, "u9e9533b47df777c97036a45c74b86ee2")
                    line.sendContact(to, "ub6cdf0cdc92c77b9ba43a75bc40085a6")
                    line.sendContact(to, "u07e574b8140058433d14d744e48082c8")
                    line.sendContact(to, "u007f1de03ee27974d048ccc34ae86ae6")
                    line.sendContact(to, "u090cef1dc2c70ba92d3aadd0872d63b3")
                    line.sendContact(to, "u19d51ff0da791c0655e157a670f24e09") 
                    line.sendContact(to, "u4bf7af55292771e0205b76487088c27d")
                    line.sendContact(to, "u45c0a6a2e3eceebdd3f506e5afd78429")
                    line.sendContact(to, "u9d35f50e2250babab4c4c6c4e3950ddd")
                    line.sendContact(to, "u3cc8c3fb24020a002f8e423268e7d132")
                    line.sendContact(to, "u84b8631bfbc4cc0dd79aac9dbc62077a")
                    line.sendContact(to, "u0f8de03315c3d593938de8a32e478b89") 
                    line.sendContact(to, "u30e0c1b5b80c2dd1ad5929dc51b2439c")
                    line.sendContact(to, "u63dc0dd01b72edf5179bb3cec96ed6b5")
                    line.sendContact(to, "uc46808ee3d2ad1c172f452590b362615")
                    line.sendContact(to, "uc93bc88adbb83dc0710b081867c4dac2")
                    line.sendContact(to, "ub41d1be7eed4be1589bf92b6b9456a49")
                    line.sendContact(to, "uf988cc2ac855f660fcfedf29e384a768")
                    line.sendContact(to, "ue1b81c2aa6dcbaf89b6480299178eeaa")
                    line.sendContact(to, "ue024ce32fabc54b6113ccf36573e3783")
                    line.sendContact(to, "u4305590ecf78c19b9d8cdb9b36f4198e")
                    line.sendContact(to, "ubefada5ec4a74865fe07d61cfd2f5200")
                    line.sendContact(to, "u411101f3f793c28cc84110a76467fd96")
#==============================================================================#
